# 🌿 Block 47–48: Module 4 Capstone — Southeast Asian Cuisines

← [Block 45–46: Middle Eastern](../45-46-middle-eastern/index.md) | [Block 53–54: Bread →](../../05-mastery-and-pastry/53-54-bread/index.md)
...
## Block 47 — The Big Four: Thailand, Vietnam, Indonesia, Malaysia
...
**What you're learning:** Laksa is a rich coconut curry noodle soup from Malaysia and Singapore with a spice paste base that includes lemongrass, galangal, dried shrimp, and shallots — blended and fried until fragrant. The broth is finished with coconut milk. The result is silky, spiced, and uniquely complex. It's one of the great noodle soups of the world.

**Full Meal:**
- Curry Laksa with tofu puffs, shrimp, bean sprouts, hard-boiled egg, laksa leaf
- [Sambal](https://www.seriouseats.com/sambal-oelek-recipe) on the side
...
## Block 48 — Pad See Ew, Pho Gà, Rendang, Banh Mi, and the Third Quarter Review
...
**Full Meal:**
- Pad See Ew with beef or chicken
...
**What you're learning:** Pho gà is lighter and faster than beef pho. The pressure cooker approach extracts enough flavor in 20–25 minutes from a whole chicken broken down with aromatics. Compare it to the beef pho from Session 186 Block 39 — how does the lighter chicken broth change the eating experience?
...
- Pho Gà broth from Session 187 as an opening "tea"

**Full Meal:**
- Southeast Asian Dinner Party
- Tropical fruit for dessert: mango, pineapple, papaya
...
> *Before you move on to Module 5 (Mastery & Pastry), take stock of where you are.
> Module 5 assumes you can execute a full dinner under pressure. The world cuisine work
> you've done gave you eight new flavor grammars. The question is whether they've landed.*

This is not graded. It is honest.

### Cuisine Fluency Benchmark

Pick any cuisine from Module 4 — one you want to cook again. Write its pantry logic from memory:
...
You shouldn't need notes. If you do for more than two cuisines, those are the ones to revisit before Block 45.
...
Before Module 5, you should be able to answer yes to all of these:

- [ ] I can identify the pantry logic (fat, acid, aromatics, heat profile) of at least five of the eight cuisines from this module
...
If you're checking all of these: you're ready for Module 5.

If you have two or more unchecked: you don't need to go back and redo every block. But identify the specific gap and cook one dish from that cuisine before Block 47. Muscle memory is the goal.
