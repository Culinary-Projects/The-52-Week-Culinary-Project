...
> **The goal of this module:** Build the physical and conceptual toolkit every cook needs before anything else — a confident knife hand, a fluent understanding of heat, the five mother sauces as a flavor map, and the ability to make great stock and eggs from memory.
...
| 7–8 | Module 1 Capstone: Stocks & Eggs | [→ Guide](07-08-stocks-and-eggs/index.md) | [→ Quick Ref](07-08-stocks-and-eggs/quick-ref.md) | [→ Shopping](07-08-stocks-and-eggs/shopping-list.md) |
...
See the [Kitchen Equipment Guide](../../equipment-guide.md) for the full list. Essential items introduced in this module:
...
*Next module: [Module 2 — Building Flavor](../02-building-flavor/README.md) (Blocks 9–16)*
