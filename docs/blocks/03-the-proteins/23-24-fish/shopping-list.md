# 🛒 Shopping List — Block 21–22: Whole Fish, Curing & Advanced Seafood

← [Back to Full Guide](index.md) | [Back to Quick Ref](quick-ref.md)

---

> **How to use this list:** Block 21 starts with a cure — buy your salmon **first** so it has 36–48 hours before you need it at Session 3. Whole fish for Session 2 (trout) and Session 4 (branzino) should be bought the day before or day-of at most. Block 22's mussels must be bought and cooked the same day. Buy mixed seafood for cioppino with a plan to cook within 24 hours.
...
## 🐟 Fish & Seafood — Block 21

**Buy salmon Thursday for the cure; all other fish as close to cook day as possible.**

- [ ] **Skin-on salmon fillet** — 1.5–2 lbs, centre-cut preferred (Session 1 gravlax). Buy Thursday. Cure immediately.
- [ ] **Whole rainbow trout** — 2 fish (1 per person), cleaned and gutted (Session 2 trout amandine). Day before or day-of.
- [ ] **Whole branzino (European sea bass)** — 2 fish, scaled and cleaned (Session 4 grilled branzino). Day-of only.
- [ ] **Fresh white fish fillets** — ½ lb halibut, snapper or sea bass (Session 5 ceviche starter). Day-of purchase only.

---

## 🦀 Seafood — Block 22

- [ ] **Live mussels** — 2 lbs (Session 6 mussels marinière). Buy day-of; store in fridge in colander, never sealed.
- [ ] **Jumbo lump crab meat** — 8 oz can or fresh (Session 7 crab cakes). Fresh Dungeness or blue crab preferred.
- [ ] **Mixed seafood for cioppino** (Session 8):
  - Littleneck clams — 12–16, scrubbed
  - Mussels — ½ lb
  - Large shrimp — ½ lb, shell-on
  - Firm white fish — ½ lb (halibut, cod or snapper)
- [ ] **Black cod (sablefish) or salmon** — 2 fillets, 6 oz each (Session 9 miso glaze). Black cod is canonical; salmon is the accessible backup.
...
- [ ] White miso paste — small tub (Session 9; lasts months after)
