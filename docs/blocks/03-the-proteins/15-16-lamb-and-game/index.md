...
### Lab 3 — Lamb Butchery Overview *(optional)*
...
> ⏰ **Planning Ahead**
>
> - **Session 69 (Slow-Roasted Shoulder):** needs 4 hours; start by early afternoon
> - **Service 17 (PROJECT: Lamb Feast):** multi-component; allow 3–4 hrs
> - **Session 70 (Braised Shanks):** 2.5–3 hrs braising; start by early afternoon

---

### Session 66 — Lamb Chops: Pan-Sear & Grill
...
### Session 67 — Rack of Lamb: The Showstopper
...
### Session 68 — Ground Lamb: Kofta and Beyond
...
### ⏰ Session 69 — Slow-Roasted Lamb Shoulder
...
### ⏰ Service 17 — A Lamb Feast for Four
...
## Block 16 — Braising Lamb & Introduction to Game
...
### Session 70 — Braised Lamb Shanks
...
### Session 71 — Lamb Navarin (French Spring Braise)

**Skill:** Navarin d'agneau is the French version of lamb stew — but it's lighter and more aromatic than the braised shanks of Session 70. The vegetables go in at different times (root vegetables early, tender vegetables late). The result should taste of spring even in winter.
...
- **Key lesson:** Navarin is the anti-braise braise — everything is lighter than the shanks from Session 70. The herbs are fresh rather than dried. The liquid is white, not red. Cook it in a Dutch oven at 325°F for 1.5 hours maximum.
...
### Session 72 — Duck: Confit Technique Introduction
...
### Session 73 — Pan-Seared Duck Breast
...
### ⏰ Service 18 — Lamb & Duck Dinner

**The challenge:** A composed dinner using both proteins from Block 16. Cook for at least four people. Plan the timing so both proteins arrive at the table rested and at proper temperature.
...
- 📖 [Serious Eats — Persian-Style Slow-Roasted Spiced Lamb Shoulder](https://www.seriouseats.com/slow-roasted-lamb-garlic-anchovy-lemon-rosemary-food-lab-recipe) — The herb and spice treatment is different; the technique is identical to what you did in Session 69. That's the whole lesson.
- 📖 [Serious Eats — Greek Moussaka](https://www.seriouseats.com/moussaka-6361068) — Ground lamb as the base of a baked layered dish with béchamel. The same ground meat from Session 68, a completely different application.
...
← [Block 13–14: Pasta & Grains](../../02-building-flavor/13-14-pasta-and-grains/index.md) | [Block 17–18: Beef →](../17-18-beef/index.md)
