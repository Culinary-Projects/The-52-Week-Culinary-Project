...
- [Session 130: Mushroom Risotto](session-130-mushroom-risotto.md)
- [Session 131: Minestrone (The Full Version)](session-131-minestrone-the-full-version.md)
- [Session 132: Osso Buco alla Milanese](session-132-osso-buco-alla-milanese.md)
- [Session 133: Ribollita (Tuscan Bean Bread Soup)](session-133-ribollita-tuscan-bean-bread-soup.md)
- [⏰ Service 33: Pan-Roasted Whole Branzino + Tiramisu](service-33-pan-roasted-whole-branzino-tiramisu.md)
...
- [Session 134: Gnocchi from Scratch](session-134-gnocchi-from-scratch.md)
- [Session 135: Pasta Fresca (Fresh Egg Pasta)](session-135-pasta-fresca-fresh-egg-pasta.md)
- [Session 136: Spaghetti alle Vongole (Revisited from Italian Perspective)](session-136-spaghetti-alle-vongole-revisited-from-italian-perspective.md)
- [Session 137: Saltimbocca alla Romana](session-137-saltimbocca-alla-romana.md)
- [⏰ Service 34: Italian Sunday Dinner](service-34-italian-sunday-dinner.md)
...
- 📖 [Basic Tomato Sauce — Bon Appétit](https://www.bonappetit.com/recipe/basic-tomato-sauce) — A walkthrough of Italian red sauce, with the reasoning behind each ingredient choice and how long to let it go.
...
- 📖 [Osso Buco — RecipeTin Eats](https://www.recipetineats.com/osso-buco/) — The full technique for the dish: the sear, the soffritto, the wine reduction, the stock, and — critically — when to add the gremolata at the end. The structure is the template for every Italian braise.
