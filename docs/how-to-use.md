...
- New equipment the block introduces (check the [Equipment Guide](equipment-guide.md))
...
Don't treat Service as just a harder session. Treat it as a performance:
- Set the table before you start
- Do full mise en place before any heat goes on
- Plate carefully and eat at the table
