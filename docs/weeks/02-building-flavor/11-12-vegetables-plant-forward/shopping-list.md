...
> **How to use this list:** Shop once at the start of Week 11. The lacto-ferment (sauerkraut) starts on Week 12 Thursday with ingredients you'll already have. Items marked **🥬 FRESH** should be selected for peak quality — buy the best-looking specimens at the market.
...
- [ ] Zucchini — 2 medium
- [ ] Scallions — 2 bunches
- [ ] Bell peppers (red, yellow, orange) — 2 of each for Week 12 stuffed peppers
- [ ] Celery root (celeriac) — 1 large (biggest one you can find)
- [ ] Parsnips — 1 lb
- [ ] Garlic — 2 bulbs (roasting a whole head Thursday)
- [ ] Lemons — 5–6
...
- [ ] Dried white beans (cannellini or Great Northern) — 1 lb **(soak night before Week 12 Tuesday)**
