...
|-----|------|-----------|-----------|
| Mon | Carne Asada Tacos | Citrus marinade; extreme-heat grill or cast iron | Thin cut; rest; slice against grain |
| Tue | Pozole Rojo | Dried chile rehydration + blend; hominy braise | Toast chiles; don't burn |
| Wed | Guacamole + Salsa Verde | Acid + salt timing; charred tomatillos | Rinse onion before adding to guac |
| Thu | **Rest** | — | — |
| Fri | Tacos al Pastor | Achiote marinade; comal/broiler finish | Pineapple chunk is not optional |
...
| Day | Dish | Technique | Key Point |
|-----|------|-----------|-----------|
| Mon | Birria de Res | All-day braise in chile marinade; consommé | Save broth for dipping |
| Tue | Simplified Mole Negro | Multi-chile; chocolate; long simmer | Balance bitter (chile) + sweet (chocolate, raisins) |
| Wed | Tamales | Masa dough; corn husks; steam 1.5 hrs | Spread masa thin; test one float test |
| Thu | **Rest** | — | — |
| Fri | Chiles Rellenos | Broil + peel; egg-white batter fry | Beat whites stiff; stuff cold |
| Sat | **PROJECT:** Full Mexican Celebration | Multi-dish service from both weeks | Prep botanas first; keep mains warm |
