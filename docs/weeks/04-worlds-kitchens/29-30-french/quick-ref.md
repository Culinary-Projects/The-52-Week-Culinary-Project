...
|-----|------|-----------|-----------|
| Mon | French Onion Soup | Low-slow caramelized onions | 45–60 mins for real caramelization |
| Tue | Eggs Benedict + Hollandaise | Blender emulsified egg-yolk sauce | 160°F danger zone — keep warm, not hot |
| Wed | Béarnaise + Steak | Tarragon reduction + egg yolk emulsion | Make reduction cold, whisk in butter warm |
| Thu | **Rest** | — | — |
| Fri | Steak Frites | Parallel timing: steak rest + fries | Twice-fry for crispy frites |
| Sat | **PROJECT:** Cassoulet | Multi-component bean braise, 4–6 hrs | Break crust and push down 3–4 times |

## Week 28 — Duck, Butter Sauces & Composed Plates

| Day | Dish | Technique | Key Point |
|-----|------|-----------|-----------|
| Mon | Beurre Blanc + Seared Fish | Cold-butter emulsion into acid reduction | Don't boil the beurre blanc — it will break |
| Tue | Duck à l'Orange | Gastrique + roasted duck | Render fat slowly; sauce balance: not too sweet |
| Wed | Cheese Soufflé | Béchamel base + folded egg whites | Stiff peaks; fold gently; serve immediately |
| Thu | **Rest** | — | — |
| Fri | French Bistro Dinner (3 courses) | Multi-course timing + composition | Do mousse ahead; mise en place everything |
