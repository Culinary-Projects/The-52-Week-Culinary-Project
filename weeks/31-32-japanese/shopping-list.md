# 🛒 Shopping List — Weeks 31–32: Japanese
...
- [ ] **Pork loin** — 4 thin cutlets, pounded flat (Tue tonkatsu)
- [ ] **Eggs** — 1 dozen (Wed tamagoyaki + Sat oyakodon)
- [ ] **Chicken thighs, boneless** — 4 (Sat oyakodon)
- [ ] **Shrimp** — ½ lb, peeled (Fri tempura)

---

## 🥩 Proteins — Week 32

- [ ] **Chicken thighs** — 4–6 bone-in or boneless (Tue teriyaki + Wed yakitori)
- [ ] **Chicken misc. parts for yakitori** — skin, thigh chunks, optionally liver (Wed)
- [ ] **Beef ribeye, very thinly sliced** — 1 lb (Fri shabu-shabu; ask butcher or use a semi-frozen block and slice yourself)
- [ ] **Ramen toppings** — soft-boiled eggs × 4, char siu pork (or use chashu from Week 19), nori
...
- [ ] Lime + lemon — for ponzu (Fri shabu)
