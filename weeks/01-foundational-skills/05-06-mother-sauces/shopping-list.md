# 🛒 Shopping List — Weeks 5–6: The 5 Mother Sauces

← [Back to Full Guide](index.md) | [Back to Quick Ref](quick-ref.md) | [Back to Master Index](../../../README.md)

---

> **How to use this list:** Weeks 5–6 are butter, flour, and eggs weeks. Buy your dairy in full at the start — you'll go through more butter and milk than you expect. The moussaka (Week 5 Sat) and eggs benedict (Week 6 Mon) both require prep the day before.
...
- [ ] Ribeye or NY strip steaks — 2 (Week 5 Fri red wine pan sauce)
- [ ] Ground lamb (or more beef) — 1 lb (moussaka meat layer)

**Week 6:**
- [ ] Canadian bacon (back bacon) — 8 slices (Week 6 Mon Eggs Benedict)
- [ ] Lobster (pre-cooked) or large shrimp — 1 lb meat (Week 6 Tue seafood roll)
- [ ] Salmon fillets — 2 pieces (Week 6 Wed Niçoise)
- [ ] Bone-in pork chops (thick-cut, 1.5") — 2 (Week 6 Fri)
- [ ] Thick-cut bacon or lardons — 6 oz (Week 6 Sat Lyonnaise salad)
- [ ] Ribeye or hanger steaks — 2 (Week 6 Sat steak frites)
...
**Week 6:**
- [ ] Watercress — 2 bunches (Week 6 Mon)
...
- [ ] Apple cider or apple cider vinegar — 1 bottle (Week 6 Fri pork chops)
- [ ] Dijon mustard — 1 jar
...
**Moussaka (Week 5 Sat) — the day-before prep:** Slice eggplant, salt generously, and let drain on paper towels for 30 minutes. This removes bitterness and prevents a watery moussaka. Béchamel also benefits from being made fresh.

**Lobster rolls (Week 6 Tue):** Pre-cooked whole lobster from a fishmonger is easiest. Or buy frozen lobster tails and steam them. Large shrimp are a fine substitute if lobster is cost-prohibitive.

**Steak frites (Week 6 Sat):** Frites need a double-fry (once at 325°F to cook through, once at 375°F to crisp). Plan to start them 30 minutes before the steaks. Or make oven fries at 450°F — not quite the same but much less mess.
